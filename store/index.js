...
export const actions = {
  async nuxtServerInit ({ dispatch }, { $axios }) {
    ...
    const portfolio = await $axios.$get('https://5xe4ems3.api.sanity.io/v2021-03-25/data/query/production?query=*[_type == "portfolio"]{name,"imageUrl":image{asset,alt},slug{current},difficulty,text,link, url, informatique}')
