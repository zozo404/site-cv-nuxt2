<template>
  <div>
    <div
      class="flex flex-col md:flex-row md:flex-wrap justify-center 2lg:flex-di-initial place-self-auto gap-4 items-center p-10 fade-scroll"
    ...
    >
      ...
      >
        <nuxt-link
          v-if="work.informatique == 'Developpement'"
        ...
        >
          <div>
            ...
            <div class="p-5">
              ...
              <button
                class="w-full rounded-md bg-black py-2 text-gray-300 hover:bg-amber-600 hover:text-black hover:shadow-md duration-200"
              >
                En savoir plus
              </button>
            </div>
...
export default {
  ...
  computed: {
    filteredWorks () {
      ...
      return this.works.filter(work => work.informatique === 'Developpement')
    }
  }
}
</script>
